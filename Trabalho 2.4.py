...
Lista_1 = ["Celia Nunes", "Dyanna Cruz", "Natalia Correia", "Renato Gomes"]
Lista_2 = ["22", "25", "21", "27"]
Lista_3 = ["7", "5", "8", "9"]
print("_"*30)
print("Nome", "\t\t", "Idade", "\t\t", "Nota")
print("")
print(Lista_1[0],"\t\t", Lista_2[0],"\t\t", Lista_3[0])
print(Lista_1[1],"\t\t", Lista_2[1],"\t\t", Lista_3[1])
print(Lista_1[2],"\t", Lista_2[2],"\t\t", Lista_3[2])
print(Lista_1[3],"\t\t", Lista_2[3],"\t\t", Lista_3[3])
print("_"*30)