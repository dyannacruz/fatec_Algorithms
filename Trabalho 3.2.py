...
# na mesma (para quem gosta de cinema)“, mostrando a ordenação no console.

#Frase desordenada [lista]:
lista = ["de cinema)", "que satisfaça o contexto", "sequenciamento de listas", "para mostrar", "a seqüência dos", "no console", "(para quem gosta", "contida na mesma",
         "elementos da lista", "Utilizar o", "da frase", "do significado"]
#Exibição ordenada:
print("lista_ordenada = ", lista[9:10], "", lista[2:3], "", lista[3:4], "", lista[5:6], "", lista[4:5], "", lista[8:9], "", lista[1:2], "", lista[11:12], "", lista[7:8])